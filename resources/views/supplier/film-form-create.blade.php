...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <form action="{{ route('supplier.film-forms.store') }}" method="POST" class="divide-y divide-gray-200">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="supplier_name"
                            class="w-full px-4 py-3 border-2 border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition bg-white"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <textarea name="packaging_list"
                            class="w-full px-4 py-3 border-2 border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition bg-white resize-none"
            ...
            <div class="p-8 bg-gray-50 flex justify-between gap-4">
                <a href="{{ route('supplier.film-forms') }}" class="btn-secondary">
