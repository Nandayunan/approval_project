...
@section('title', 'Persetujuan Export-Import')

@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Persetujuan Export-Import</h1>
        <p class="text-gray-600 mt-2">Lihat formulir yang menunggu persetujuan dan riwayat formulir yang sudah disetujui.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-600">
            ...
            <p class="text-gray-600 text-sm mt-2">Formulir yang sudah selesai</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                        ...
                        @foreach ($approvals as $approval)
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if ($modelAlias)
                                        <a href="{{ route('export_import.view-form', [$modelAlias, $approval->model_id]) }}"
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 text-sm mt-2">Semua formulir sudah ditinjau oleh tim Export-Import.</p>
            </div>
        @endif
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 text-sm mt-2">Tunggu hingga tim Export-Import meninjau semua permintaan.</p>
            </div>
        @endif
    </div>
@endsection
